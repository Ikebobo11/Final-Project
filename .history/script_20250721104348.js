...
Lhideicon.addEventListener("click",hidecontent)let goods = document.querySelector("goods")
function directo(){
    window.location.href="product.html"
}
goods.addEventListener("click",directo)
...
function scrollsecondmarketfront(){
    Lmaincat.scrollLeft = Lmaincat.scrollLeft + Lmaincat.clientWidth
}
Lfrontb.addEventListener("click",scrollsecondmarketfront)

function scrollsecondmarketback(){
     Lmaincat.scrollLeft = Lmaincat.scrollLeft - Lmaincat.clientWidth
}
Lbackb.addEventListener("click",scrollsecondmarketback)